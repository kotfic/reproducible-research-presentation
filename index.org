...
#+BEGIN_NOTES
Trying to understand exactly how git does this is where things start to get complicated.
...
** Lets see an Example
[[https://github.com/kotfic/reproducible-research-presentation/blob/gh-pages/index.html][reproducible-research-presentation]]
#+BEGIN_NOTES
